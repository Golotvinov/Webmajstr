...
?>
    ...
    <section class="content">
        ...
        <section id="main-content-area">
            ...
            <p class="description">Abychom mohli konzumovat obsah Internetu budeme potřebovat dvě věci: Zařízení, které
            ...
            <p class="description">V dnešní době máme velký výběr aplikací na zobrazování webového obsahu (webových
            ...
            <p class="description">Zde je stručný seznam těch nejpouživanějších:</p>
            ...
            <p class="description">Každý z těchto programů plní stejnou fundamentální roli, avšak každý z nich se trochu liší („pod kapotou" se však některé liší velmi výrazně). Základní funkce jako záložky, nastavení domovské stránky, blokování vyskakovacích oken, uložení hesel a stažení různých doplňků mají všechny. Každý vývojář se ale zaměřuje na něco trochu jiného.
            <p class="description">Google například nabízí uživatelům pohodlí při používání a jednoduchost za cenu horších podmínek ochrany soukromí. Zkrátka tam platíte svými daty Googlu za to, že vám nabízí úzkou integrovanost Chromu s dalšími z řady svých produktů.</p>
            <p class="description">Mozilla vyvíjí Firefox a cílí jak na pokročilejší, tak i na „obyčejné" uživatele. Slibuje výbornou ochranu soukromí, automatické blokování reklam a sledovacích prvků na netu a open source přístup (svobodný zdrojový kód).</p>
            <h4>Vykreslení obsahu</h4>
            <p class="description">Architektura webového prohližeče není moc náročná Skládá se primárně z těchto částí:</p>
            <ul>
