<section id="main-content-area">
            ...
            <p class="text">Na Webmajstru si můžeš témata studovat v libovolném pořadí, ale doporučujeme se držet
                ...
                v
                hlavní nabídce zleva doprava, od sekce <b>O Webu</b> až po <b>Kvíz</b>, ve kterém si
                budeš
            ...
            <a href="/layout" class="fatLink">Rozložení (layout)</a><a href="/barvy" class="fatLink">Barvy</a><a href="/typografie" class="fatLink">Typografie</a>
            ...
            <p class="text">Zde najdeš celou řadu užitečných nástrojů a aplikací, které jsme osobně vybrali, a které ti pomůžou s tvorbou webových stránek a aplikací. Ať už to bude grafika či vývoj.</p>
                <h4><a href="https://webmajstrkviz.golotvinov.com/" target="_blank">Kvíz</a></h4>
            ...
            <hr class="content-divider">
            <h3>O projektu</h3>
            <p class="text">Tento web vytvořil Aleks D. Golotvinov jako seminární práci na předmět Tvroba a vývoj webových aplikací, ve spolupráce s KITTV a panem doktorem T. Jeřábkem. Tento web se bude dále rozšiřovat, doplňovat a zlepšovat.</p>
        </section>
    </section>
