...
function showtask() {
    ...
    taskObj.forEach((item, index) => {
        ...
        html += `<tr>
                    ...
                    ${taskCompleteValue}
                    <td><button type="button" onclick="edittask(${index})" class="text-primary"></i>Upravit</button></td>
                    <td><button type="button" onclick="deleteitem(${index})" class="text-danger"></i>Smazat</button></td>
                </tr>`;
    });
