   ...
   <header>
    ...
    <section class="content">
        ...
        <section id="main-content-area">
            ...
            <hr class="content-divider">
            <h3>O projektu</h3>
            <p class="text">Tento web vytvořil Aleks D. Golotvinov jako seminární práci na předmět Tvroba a vývoj webových aplikací, ve spolupráce s KITTV a panem doktorem T. Jeřábkem. Web se bude průběžně aktualizovat a doplňovat.</p>
        </section>
    </section>
<?php
